  ...
  "roadmap": [ 
    {
      ...
      "desc": "Nâng cao kiến thức chuyên môn thông qua các khóa học online, sách chuyên ngành, và lấy các chứng chỉ quan trọng liên quan đến ${targetCareer}.",
    ...
    },
    {
      ...
      "desc": "Chuẩn bị CV, phỏng vấn, và ứng tuyển vào các công ty uy tín. Liên tục học hỏi, cập nhật xu hướng để thăng tiến trong sự nghiệp ${targetCareer}.",
